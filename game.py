...
class Player(object):
    # might need to further integrate human and computer players
    pass
...
class ComputerPlayer(Player):
    # an instance of the player class
    # will include randomization to help the computer take its move
    # or might include some basic rules to help computer player learn
...
class Board(object):
    ...
    def arrange_board(self):
        board = [self.tiles[0], self.tiles[1], self.tiles[2]], [self.tiles[3], self.tiles[4], self.tiles[5]], [
...
class Move(object):
    ...
    def ask_for_move(self):
        ...
        while (flag != True):
            move = input("Please enter the number where you want to move your " + self.player.symbol + ":")
